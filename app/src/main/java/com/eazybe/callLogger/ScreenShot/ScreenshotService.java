...
public class ScreenshotService extends Service {
    ...
    public int onStartCommand(Intent i, int flags, int startId) {
        if (i.getAction()==null) {
            ...
            if (resultData!=null) {
                ...
                Intent ui=
                        new Intent(this, ScreenShotActivity.class)
    ...
    private void startCapture() {
        ...
        vdisplay=projection.createVirtualDisplay("eazybe",
    ...
    private void foregroundify() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            startForeground(NOTIFY_ID, b.build(), ServiceInfo.FOREGROUND_SERVICE_TYPE_MEDIA_PROJECTION);
        }else{
